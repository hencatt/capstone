...
if (isset($_POST['login'])) {
    ...
    if ($select && mysqli_num_rows($select) > 0) {
        ...
        echo "<div class='alert alert-danger' role='alert'>Invalid email or username.</div>";
    }
}
?>
