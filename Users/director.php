...
<body>
            ...
            <div id="contents">
                ...
                <div class="row mt-4 d-flex flex-row gap-4">
                    <div class="col-6 position-static "
                        style="background-color:white; border-radius: 10px; padding: 20px; width: min-content;">
                        <div id="genderChart" style="margin: auto;"></div>
                    </div>
                    <div class="col"
                        style="background-color:white; border-radius: 10px; padding: 20px;  max-height: 450px">
                            ...
                            if (is_string($eventLists)) {
                                ...
                                while ($row = $eventLists->fetch_assoc()) {
                                    ...
                                    <div class="card mb-3 position-static"
                                        style="margin-top: .75rem; width: 100%; position: static; ">
                                        <div class="row g-0  ">
                ...
                <hr>
                <div class="row mt-5"
                    style="background-color:white; border-radius: 10px; margin-top:1rem; overflow-x: auto: height:600px;">
                    <div class="col">
    ...
    <script>
        ...
        const deptLayout = {
            ...
            barmode: 'overlay', // use 'group' for multiple traces
            ...
            yaxis: { title: 'Number of Employees', dtick: 10, tickformat: 'd', showgrid: true, gridcolor: '#eee' },
            bargap: 0.65,
            bargroupgap: 0.6,
