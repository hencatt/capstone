<?php
    ...
    // Restrict access based on position
            ...
            <div class="users">
                ...
                <table class="users-table">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT id, fname, lname, email, username, position, department, campus FROM accounts_tbl WHERE is_active = 1";
            ...
            <div class="modals" id="edit_account_modal" style="display: none;">
                <div class="modal_edit_account">
                    ...
                    <form method="post" class="form_edit_account" novalidate>
                        ...
                        <select name="edit_campus" id="edit_campus" class="form-select" required>
                            <option value="" disabled selected>Select Campus</option>
                            <option value="Sumacab">Sumacab</option>
                            <option value="GT">Gen. Tinio</option>
                            <option value="San Isidro">San Isidro</option>
