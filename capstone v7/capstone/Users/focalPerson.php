...
if ($_SESSION['user_position'] !== 'Focal Person') {
    if ($_SESSION['user_position'] === 'Director') {
        header("Location: director.php");
    } elseif ($_SESSION['user_position'] === 'Technical Assistant') {
        ...
        <div class="col sidebar">
            <div class="row mt-lg-3 topLeft">
                <div class="col neustLogo">
                    ...
                    <img src="../assets/GADLogo.jpg" style="width: 60px; height: 60px;" alt="GADLogo" class="logo">
                </div>
                <div class="Title" style="text-align: center;">
                    <br>
                    <h4>NEUST GAD Portal</h4>
                </div>
            </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="row">
                                        <div class="col d-flex flex-row justify-content-end gap-3">
                                            ...
                                            <select name="filterDept" id="filterDept" class="form-select">
                                                ...
                                                <?php
                                                // Fetch the department of the focal person
                                                $userId = $_SESSION['user_id'];
                                                $sql = "SELECT department FROM accounts_tbl WHERE id = ?";
                                                $stmt = $con->prepare($sql);
                                                $stmt->bind_param("i", $userId);
                                                $stmt->execute();
                                                $result = $stmt->get_result();
                                                ...
                                                if ($result->num_rows > 0) {
                                                    ...
                                                    // Display the department of the focal person
                                            ...
                                            <select name="filterCampus" id="filterCampus" class="form-select">
                                                ...
                                                <?php
                                                // Fetch the campus of the focal person
                                                $userId = $_SESSION['user_id'];
                                                $sql = "SELECT campus FROM accounts_tbl WHERE id = ?";
                                                $stmt = $con->prepare($sql);
                                                $stmt->bind_param("i", $userId);
                                                $stmt->execute();
                                                $result = $stmt->get_result();
                                                ...
                                                if ($result->num_rows > 0) {
                                                    $row = $result->fetch_assoc();
                                                    $currentCampus = $row['campus'];

                                                    // Display the campus of the focal person
                                                    echo "<option value='$currentCampus' selected>$currentCampus</option>";
                                                } else {
                                                    echo "<option value='' disabled>No Campus Found</option>";
                                                }
                                    ...
                                    <div class="row mt-lg-2">
                                        <div class="col d-flex flex-row justify-content-end gap-3 align-items-center">
                                            <label for="checkboxShowSummary" class="form-check-label">Show
                                                Summary</label>
                                            <input type="checkbox" id="checkboxShowSummary" name="checkboxShowSummary"
                                                class="form-check-input" value="Show Summary">
                                        </div>
                                        <div class="col d-flex flex-row align-items-center justify-content-end gap-3">
                                ...
                                <table class="table-responsive">
                                   <table class="table table-striped table-sm" id="employeeTable">
                                        ...
                                        <tbody id="employeeTableBody">
                                            ...
                                            if (!isset($_SESSION['user_id'])) {
                                                echo "<tr><td colspan='5'>No data available. User not logged in.</td></tr>";
                                                exit();
                                            }
                                            // Fetch department and campus for the logged-in user
                                            $userId = $_SESSION['user_id'];
                                            $sql = "SELECT department, campus FROM accounts_tbl WHERE id = ?";
                                            $stmt = $con->prepare($sql);
                                            $stmt->bind_param("i", $userId);
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                echo "<tr><td colspan='5'>No data available. Department or Campus not found.</td></tr>";
                                                exit();
                                            }
                                            // Fetch employee data based on department and campus
                                            $sql = "SELECT
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                echo "<tr><td colspan='5'>No data available for the selected department and campus.</td></tr>";
                                            }
                                            $stmt->close();
                                            ?>
                                        </tbody>
