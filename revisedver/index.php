        ...
        <div class="mainContent">
            ...
            <div class="leftSide">
                ...
                <form action="" class="row">
                    <div class="col-md-12">
                        ...
                        <input type="email" class="form-control" id="inputEmail" placeholder="Enter Email or Username">
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="row lowerPart">
                        <div class="col-md-12">
                            ...
                            <button type="button" class="btn btn-warning btn-md btn-block"><b>Login</b></button>
            ...
            <div class="rightSide">
                <div class="col-md-12 images">
                        ...
                        <img src="./assets/GAD.jpg" alt="GAD Picture">
                    </div>
            </div>
