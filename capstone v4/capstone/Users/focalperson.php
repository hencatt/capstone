...
if (isset($_POST['addItem'])) {
    ...
    $itemCheck = "SELECT itemName FROM inventory_tbl WHERE itemName = ?";
    $stmt = $con->prepare($itemCheck);
    $stmt->bind_param("s", $itemName);
    $stmt->execute();
    $scanResult = $stmt->get_result();
    ...
    if (isset($_FILES['fileToUpload']) && $_FILES['fileToUpload']['error'] === UPLOAD_ERR_OK) {
        ...
        if ($scanResult->num_rows > 0) {
            ...
            $sql = "INSERT INTO inventory_tbl (itemName, itemDesc, itemImage, itemStatus, itemQuantity) 
                    VALUES (?, ?, ?, ?, ?)";
            $stmt = $con->prepare($sql);
            $stmt->bind_param("ssssi", $itemName, $itemDesc, $itemImg, $itemStatus, $itemQuant);
...
<head>
    ...
    <link rel="stylesheet" href="../focalPerson.css" type="text/css">
    <!-- font link -->
        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-sm-8 col-xs-6 mt-lg-3 mainContent">
                ...
                <div class="emp_table">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_emp_modal">
                        Add Employee
