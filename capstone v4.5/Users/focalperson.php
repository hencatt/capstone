        ...
        <div class="col-lg-10 col-sm-8 col-xs-6 mt-lg-3 mainContent">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row ">
                        <div class="col-lg-10">
                            <div class="row preview d-flex align-items-center justify-content-center">
                                <div class="col-lg-10">
                                    <h1>Employee</h1>
                                </div>
                                <div class="col">
                            ...
                            <div class="row overview mt-lg-5 mb-lg-5">
                                ...
                                <div class="col">
                                    <h6>Total Stock of All Items</h6><br>
                                    <h4 class="itemText">
                                        <?php
                                        $con = new mysqli("localhost", "root", "", "gad_portal");
                                        $sql = "SELECT id, itemQuantity FROM inventory_tbl";
                                        $result = $con->query($sql);
